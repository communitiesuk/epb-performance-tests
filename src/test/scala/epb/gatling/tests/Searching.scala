...
class Searching extends Simulation {
  ...
  setUp(
    scnDomesticPostcodeSearch.inject(rampUsersPerSec(1).to(18).during(2700),constantUsersPerSec(18).during(300).randomized,rampUsersPerSec(18).to(1).during(600)).protocols(httpProtocolFindService),
    scnNonDomesticPostcodeSearch.inject(rampUsersPerSec(1).to(18).during(2700),constantUsersPerSec(18).during(300).randomized,rampUsersPerSec(18).to(1).during(600)).protocols(httpProtocolFindService),
    scnAssessorPostcodeSearch.inject(rampUsersPerSec(1).to(18).during(2700),constantUsersPerSec(18).during(300).randomized,rampUsersPerSec(18).to(1).during(600)).protocols(httpProtocolGetService)
  )
    .assertions(
